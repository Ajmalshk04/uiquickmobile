...
const Services = () => {
  return (
    <section className='lg:container lg:mx-auto'>
        ...
        <div className='flex flex-wrap lg:gap-6 sm:gap-4 w-full h-auto lg:px-20 sm:px-2 lg:py-10 sm:py-2 rounded-[25px] items-center justify-center mt-4 relative overflow-hidden'>
