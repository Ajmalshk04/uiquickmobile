  ...
  return (
    <footer className="relative left-0 bottom-0 w-full mt-6 border-t-[1px] border-gray-200">
        <div className="flex lg:flex-row flex-wrap sm:flex-col lg:justify-evenly lg:px-12 sm:px-6 lg:py-10 sm:py-6">
            <div className="flex flex-col text-gray-700 sm:text-center lg:text-left lg:p-10 md:p-8 sm:p-4 lg:gap-5 sm:gap-3">
        ...
        <div className=" text-gray-700 sm:text-center lg:text-left lg:p-10 md:p-8 sm:p-4">
          <p className=" font-semibold text-base sm:text-center lg:text-left pb-4">Services</p>
          <div className="flex flex-col text-sm lg:gap-3 sm:gap-1">
          <Link href={"/"}><a>Sell Phone</a></Link>
          <Link href={"/"}><a>Buy Phone</a></Link>
          <Link href={"/"}><a>Repair Phone</a></Link>
          </div>
        </div>
        <div className=" text-gray-700 sm:text-center lg:text-left lg:p-10 md:p-8 sm:p-4">
          <p className=" font-semibold text-base sm:text-center lg:text-left pb-4">Other links</p>
          <div className="flex flex-col text-sm lg:gap-3 sm:gap-1">
          <Link href={"/"}><a>Sell Phone</a></Link>
          <Link href={"/"}><a>Buy Phone</a></Link>
          <Link href={"/"}><a>Repair Phone</a></Link>
        ...
        <div className=" text-gray-700 sm:text-center lg:text-left lg:p-10 md:p-8 sm:p-4">
          <p className=" font-semibold text-base sm:text-center lg:text-left pb-4">Links</p>
          <div className="flex flex-col text-sm lg:gap-3 sm:gap-1">
          <Link href={"/"}><a>Sell Phone</a></Link>
          <Link href={"/"}><a>Buy Phone</a></Link>
          <Link href={"/"}><a>Repair Phone</a></Link>
        ...
        <div className=" text-gray-700 sm:text-center lg:text-left lg:p-10 md:p-8 sm:p-4">
          <p className=" font-semibold text-base sm:text-center lg:text-left pb-4">Help & Support</p>
          <div className="flex flex-col text-sm lg:gap-3 sm:gap-1">
          <Link href={"/"}><a>Sell Phone</a></Link>
          <Link href={"/"}><a>Buy Phone</a></Link>
          <Link href={"/"}><a>Repair Phone</a></Link>
